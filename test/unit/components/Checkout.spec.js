...
describe('Checkout component', () => {
  ...
  it(`should render a 'Continue shopping' link to the Categorize`, () => {
    ...
    assert.equal(continueShoppingLink.prop('to'), routes.Categorize, `the 'Continue shopping' link did not go to the Categorize`)
  });
