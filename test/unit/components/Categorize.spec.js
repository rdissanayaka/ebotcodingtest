...
import { Categorize } from '../../../app/js/components/Categorize'
...
describe('Categorize component', () => {
  it(`should render a 'Basket' link to the Checkout`, () => {
    const { basketLink } = render(<Categorize {...props} />);
  ...
  it('should render the product catalogue', () => {
    const { productCatalogue } = render(<Categorize {...props} />);
  ...
  it(`should render a 'Proceed to checkout' link to the Checkout`, () => {
    const { proceedToCheckoutLink } = render(<Categorize {...props} />);
  ...
  it(`should call 'getAllProducts' when it mounts`, () => {
    const { instance } = render(<Categorize {...props} />);
  ...
  it(`should render a 'loading' notification when products are being fetched`, () => {
    const { loading } = render(<Categorize {...props} isFetching={true} />);
